...
public class Operation implements java.io.Serializable {
	...
	public static final Operation	GET_ROUTE_INFO		= new Operation(
																"get-route-information", Capability.JUNOS);

	public static final Operation	GET_INTERFACE_INFO	= new Operation(
																"get-interface-information", Capability.JUNOS);

	public static final Operation	GET_SOFTWARE_INFO	= new Operation(
																"get-software-information", Capability.JUNOS);
